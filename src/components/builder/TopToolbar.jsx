...
export default function TopToolbar() {
  ...
  return (
    <div className="h-16 border-b border-gray-200 bg-white px-6 flex items-center justify-between sticky top-0 z-20">
      ...
      <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 flex items-center gap-6">
        ...
        {/* Device Previews (Only show in Appearance? No, keep it) */}
        ...
        <div className="flex items-center gap-4">
          {/* Save Status */}
          <div className="flex items-center gap-2 text-sm text-gray-500 min-w-[120px] justify-end"></div>
          ...
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 rounded-full border border-gray-200 text-gray-700 dark:text-white hover:bg-gray-50 dark:hover:bg-white/10 font-medium text-sm transition-all shadow-sm"
          >
            <Eye size={16} />
            Preview
          </button>
          ...
          <button
            ...
            className="flex items-center gap-2 px-6 py-2 rounded-full bg-gray-900 text-white hover:bg-black dark:bg-white! dark:text-black! dark:hover:bg-gray-100 font-medium text-sm transition-all shadow-md shadow-gray-900/20 active:scale-95 disabled:opacity-50 whitespace-nowrap shrink-0"
          >
            {saveStatus === "saving" ? (
