    ...
    <section className="relative min-h-screen pt-32 pb-20 overflow-hidden bg-[#FAFAF8] flex items-center">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 w-full grid lg:grid-cols-12 gap-12 lg:gap-16 items-center">
        ...
        <motion.div
          ...
          className="lg:col-span-6 relative mt-12 lg:mt-0 flex justify-center items-center h-[500px]"
        >
          {/* Laptop Mockup */}
          <motion.div
          ...
          <motion.div
            ...
            className="absolute -bottom-4 -left-4 sm:left-2 w-[190px] bg-white rounded-[26px] shadow-[0_20px_50px_rgba(74,44,58,0.2)] border-[5px] border-[#4A2C3A] overflow-hidden hidden sm:block z-20 hover:scale-105 transition-all duration-300"
          >
          ...
          <motion.div
            ...
            className="absolute top-6 -right-6 bg-white/95 backdrop-blur-sm p-2.5 rounded-xl border border-[#4A2C3A]/5 shadow-lg flex items-center space-x-2.5 z-35"
          >
          ...
          <motion.div
            ...
            className="absolute top-1/2 -right-12 bg-white/95 backdrop-blur-sm p-3 rounded-xl border border-[#4A2C3A]/5 shadow-lg flex flex-col space-y-1 z-35"
          >
          ...
          <motion.div
            ...
            className="absolute -top-8 left-16 bg-white/95 backdrop-blur-sm p-3 rounded-xl border border-[#4A2C3A]/5 shadow-lg flex items-center space-x-2.5 z-35"
          >
          ...
          <motion.div
            ...
            className="absolute bottom-10 left-32 bg-white/95 backdrop-blur-sm px-3 py-2.5 rounded-xl border border-[#4A2C3A]/5 shadow-lg flex items-center space-x-2 z-35"
          >
          ...
          <motion.div
            ...
            className="absolute bottom-4 right-8 bg-white/95 backdrop-blur-sm px-3 py-2 rounded-full border border-[#4A2C3A]/5 shadow-md flex items-center space-x-1.5 z-35"
          >
