...
export const PricingTeaser = () => {
  ...
  return (
    <section id="pricing" className="py-24 bg-[#FAFAF8] border-t border-[#4A2C3A]/5 scroll-mt-16 relative overflow-hidden">
      {/* Background */}
      <div className="absolute inset-0 z-0 pointer-events-none overflow-hidden">
        <div className="blob-1 absolute top-1/3 left-1/3 w-[400px] h-[400px] rounded-full bg-[#B88A44]/4 blur-[100px]" />
      </div>
            ...
            return (
              <motion.div
                ...
                className={`flex flex-col border rounded-[28px] p-8 relative transition-colors duration-300 bg-white/65 backdrop-blur-md cursor-pointer ${
                  isPro
                    ? 'border-[#B88A44] border-2 shadow-[0_20px_50px_-10px_rgba(184,138,68,0.18)] z-10'
                    : 'border-[#4A2C3A]/6'
                }`}
              >
                ...
                <motion.div
                  ...
                  className={`absolute inset-0 rounded-[28px] pointer-events-none ${
                    isPro
                      ? 'bg-gradient-to-br from-[#B88A44]/6 to-transparent'
                      : 'bg-gradient-to-br from-[#4A2C3A]/3 to-transparent'
                  }`}
                />
                ...
                {isPro && (
                  <motion.span
                    ...
                    className="absolute -top-3.5 left-1/2 -translate-x-1/2 px-3.5 py-1 bg-[#B88A44] rounded-full text-[9px] font-bold text-[#FAFAF8] uppercase tracking-wider shadow-md shadow-[#B88A44]/25 flex items-center space-x-1"
                  >
                ...
                <div className="flex-1 space-y-3.5 mb-8 border-t border-[#4A2C3A]/5 pt-6 text-left relative z-10">
                  {plan.features.map((feature, i) => (
                    <motion.div
                      ...
                      className="flex items-start space-x-2.5 text-xs text-[#6B6B6B]"
                    >
                ...
                <Link href={plan.href} className="w-full mt-auto relative z-10">
                  <motion.button
                    ...
                    className={`w-full py-3.5 px-4 rounded-xl text-xs font-bold transition-colors duration-300 border ${
                      isPro
                        ? 'bg-[#4A2C3A] text-white border-[#4A2C3A] hover:bg-[#3d2430] shadow-md shadow-[#4A2C3A]/12'
