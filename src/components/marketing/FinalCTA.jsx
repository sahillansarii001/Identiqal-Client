        ...
        <AnimatedSection>
          <div className="relative rounded-[36px] bg-primary border border-accent/25 px-8 py-16 sm:px-16 sm:py-24 text-center overflow-hidden shadow-[0_30px_70px_rgba(30, 64, 175,0.28)]">
            ...
            <motion.div
              ...
              className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] rounded-full bg-linear-to-tr from-accent/18 to-transparent blur-[110px] pointer-events-none"
            />
            ...
            <div className="absolute bottom-0 left-0 w-48 h-48 bg-accent/5 rounded-full blur-[50px] pointer-events-none" />

            {/* Badge */}
            <motion.div
              animate={shouldReduceMotion ? {} : { scale: [1, 1.03, 1] }}
              transition={{ duration: 3, repeat: Infinity, ease: "easeInOut" }}
              className="relative z-10 inline-flex items-center space-x-1.5 px-3 py-1 rounded-full bg-white/6 border border-white/10 text-xs font-semibold text-brand-bg mb-6"
            >
            ...
            {/* Heading */}
            <h2 className="relative z-10 text-3xl sm:text-5xl font-extrabold text-brand-bg tracking-tight leading-tight max-w-3xl mx-auto font-sans">
              Make Every First{" "}
              <motion.span
                animate={
                  shouldReduceMotion
            ...
            <div className="relative z-10 flex flex-col sm:flex-row items-center justify-center space-y-3 sm:space-y-0 sm:space-x-4 mt-10">
              <Link href="/signup" className="w-full sm:w-auto">
                <motion.button
                  ...
                  className="group w-full sm:w-auto inline-flex items-center justify-center space-x-2 bg-accent hover:bg-[#a37938] text-brand-bg font-bold px-8 py-4 rounded-xl shadow-lg shadow-accent/25 transition-colors duration-300 border border-accent"
                >
