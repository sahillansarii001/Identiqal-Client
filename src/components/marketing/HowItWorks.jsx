...
export const HowItWorks = () => {
  ...
  return (
    <section id="how-it-works" className="py-20 bg-slate-950/70 border-t border-slate-900 scroll-mt-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-4 gap-8">
          {steps.map((step, index) => (
            <div key={index} className="bg-slate-900/25 border border-slate-900 hover:border-slate-800 rounded-2xl p-6 transition-all duration-300">
              <div className="w-12 h-12 bg-slate-950 border border-slate-850 rounded-xl flex items-center justify-center mb-6">
                {step.icon}
              </div>
