        ...
        <div className="bg-white min-h-[500px] p-6 flex flex-col justify-between font-sans text-left select-none">
          <div className="space-y-6 pt-4">
            <div className="flex items-center justify-between">
              <div className="w-14 h-14 rounded-full border border-black flex items-center justify-center text-black font-semibold text-base">AM</div>
              <div className="text-[8px] font-bold uppercase tracking-widest text-black border border-black/10 px-2.5 py-0.5 rounded-none bg-white">PRO MEMBER</div>
            </div>
            <div className="space-y-1.5">
              <h4 className="font-light text-xl text-black tracking-tight">{profile.name}</h4>
              <p className="text-xs font-normal text-zinc-800 tracking-tight">{profile.title}</p>
              <p className="text-[10px] text-zinc-500 font-light tracking-wide uppercase">{profile.company}</p>
            </div>
            <p className="text-[11px] font-light leading-relaxed text-zinc-600 pt-3 border-t border-zinc-100">{profile.bio}</p>
          </div>
          <div className="space-y-2 my-6">
            <button className="w-full py-2.5 bg-black text-white text-xs font-semibold rounded-none tracking-wide">Save Contact Card</button>
            <button className="w-full py-2.5 bg-white border border-zinc-200 text-black text-xs font-semibold rounded-none tracking-wide">Connect Online</button>
          </div>
          <div className="space-y-2">
            ...
            <div className="p-4 border border-zinc-100 space-y-2">
              {[profile.email, profile.phone, profile.location].map((v) => (
                <div key={v} className="flex items-center space-x-2 text-[10px] text-zinc-700">
                  <span className="w-1 h-1 bg-black rounded-full" /><span>{v}</span>
                </div>
              ))}
            </div>
          </div>
      ...
      return (
        <div className="bg-black min-h-[500px] p-6 flex flex-col justify-between font-sans text-left select-none relative overflow-hidden">
          ...
          <div className="space-y-5 pt-4 relative z-10">
            <div className="flex items-center justify-between">
              <div className="w-14 h-14 rounded-full border-2 border-[#A855F7] bg-zinc-950 flex items-center justify-center text-white font-black text-lg shadow-[0_0_15px_rgba(168,85,247,0.3)]">AM</div>
              <div className="text-[8px] font-black tracking-widest text-[#A855F7] bg-[#A855F7]/10 border border-[#A855F7]/30 px-3 py-1 rounded-full uppercase">PRO MEMBER</div>
            </div>
            <div className="space-y-1">
              <h4 className="text-lg font-black text-white tracking-tight">{profile.name}</h4>
              <p className="text-xs font-semibold text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-500">{profile.title}</p>
              <p className="text-[10px] text-zinc-500 tracking-wide uppercase font-bold">{profile.company}</p>
            </div>
            <p className="text-[11px] leading-relaxed text-zinc-400 border-t border-zinc-900 pt-3">{profile.bio}</p>
          </div>
          <div className="space-y-2 my-6 relative z-10">
            <button className="w-full py-2.5 bg-white text-black text-xs font-black rounded-xl">Save Contact Card</button>
            <button className="w-full py-2.5 bg-zinc-900 border border-zinc-800 text-white text-xs font-semibold rounded-xl">Connect Online</button>
          </div>
          <div className="space-y-2 relative z-10">
            ...
            <div className="p-3 bg-zinc-950/80 border border-zinc-900 rounded-2xl space-y-2">
              {[[Mail, profile.email], [Phone, profile.phone], [MapPin, profile.location]].map(([I, v]) => (
                <div key={v} className="flex items-center space-x-2.5 text-[10px] text-zinc-300">
                  <I size={10} className="text-[#A855F7]" /><span>{v}</span>
                </div>
              ))}
            </div>
          </div>
    ...
    case 'glass':
      return (
        <div className="bg-gradient-to-tr from-[#1E293B] to-[#0F172A] min-h-[500px] p-6 flex flex-col justify-between font-sans text-left select-none relative overflow-hidden">
          ...
          <div className="space-y-5 pt-4 relative z-10">
            <div className="flex items-center justify-between">
              <div className="w-14 h-14 rounded-full bg-white/20 backdrop-blur-md border border-white/30 flex items-center justify-center text-white font-bold text-lg">AM</div>
              <div className="text-[8px] font-extrabold tracking-widest text-white/90 bg-white/10 backdrop-blur-md border border-white/20 px-3 py-1 rounded-full uppercase">PRO MEMBER</div>
            </div>
            <div className="space-y-1">
              <h4 className="text-lg font-extrabold text-white tracking-tight">{profile.name}</h4>
              <p className="text-xs font-semibold text-white/80">{profile.title}</p>
              <p className="text-[10px] text-white/40 tracking-wide uppercase font-bold">{profile.company}</p>
            </div>
            <p className="text-[11px] leading-relaxed text-white/70 border-t border-white/10 pt-3">{profile.bio}</p>
          </div>
          <div className="space-y-2.5 my-6 relative z-10">
            <button className="w-full py-2.5 bg-white/25 border border-white/20 backdrop-blur-md text-white text-xs font-bold rounded-2xl">Save Contact Card</button>
            <button className="w-full py-2.5 bg-transparent border border-white/10 text-white/90 text-xs font-semibold rounded-2xl">Connect Online</button>
          </div>
          <div className="space-y-2 relative z-10">
            ...
            <div className="p-3 bg-white/5 backdrop-blur-md border border-white/10 rounded-2xl space-y-2">
              {[[Mail, profile.email], [Phone, profile.phone], [MapPin, profile.location]].map(([I, v]) => (
                <div key={v} className="flex items-center space-x-2 text-[10px] text-white/90">
                  <I size={10} className="text-white/60" /><span>{v}</span>
                </div>
              ))}
            </div>
          </div>
    ...
    case 'gradient':
      return (
        <div className="min-h-[500px] p-6 flex flex-col justify-between font-sans text-left select-none relative overflow-hidden">
          ...
          <div className="space-y-5 pt-4 relative z-10">
            <div className="flex items-center justify-between">
              <div className="w-14 h-14 rounded-2xl bg-white/20 backdrop-blur-md border border-white/45 flex items-center justify-center text-white font-black text-lg">AM</div>
              <div className="text-[8px] font-black tracking-widest text-white bg-pink-500 border border-white/25 px-3 py-1 rounded-full uppercase">PRO MEMBER</div>
            </div>
            <div className="space-y-1">
              ...
              <p className="text-[10px] text-white/60 tracking-wide uppercase font-black">{profile.company}</p>
            </div>
            <p className="text-[11px] leading-relaxed text-white/80 border-t border-white/10 pt-3">{profile.bio}</p>
          </div>
          <div className="space-y-2.5 my-6 relative z-10">
            <button className="w-full py-2.5 bg-white text-[#A855F7] text-xs font-black rounded-2xl">Save Contact Card</button>
            <button className="w-full py-2.5 bg-black/25 border border-white/15 text-white text-xs font-bold rounded-2xl">Connect Online</button>
          </div>
          <div className="space-y-2 relative z-10">
            ...
            <div className="p-3 bg-black/15 border border-white/10 rounded-2xl space-y-2">
              {[[Mail, profile.email], [Phone, profile.phone], [MapPin, profile.location]].map(([I, v]) => (
                <div key={v} className="flex items-center space-x-2 text-[10px] text-white">
                  <I size={10} className="text-white" /><span>{v}</span>
                </div>
              ))}
            </div>
          </div>
...
export const LivePreview = () => {
  ...
  const rotateX = useSpring(useTransform(mouseY, [-0.5, 0.5], [3, -3]), { stiffness: 140, damping: 28 });
  const rotateY = useSpring(useTransform(mouseX, [-0.5, 0.5], [-3, 3]), { stiffness: 140, damping: 28 });
    ...
    <section id="templates" className="py-24 bg-[#FAFAF8] border-t border-[#E9E2DC]/80 scroll-mt-16 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 grid lg:grid-cols-12 gap-12 lg:gap-16 items-center">
        ...
        <div className="lg:col-span-5 space-y-8 text-left">
          ...
          {/* Theme selection */}
          <AnimatedSection delay={0.1} className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            {themes.map((theme) => {
              ...
              return (
                ...
                >
                  ...
                  <span className="text-[9px] uppercase font-bold tracking-wider text-[#8A8A8A]">{theme.sub}</span>
                </motion.button>
              );
            })}
          </AnimatedSection>
