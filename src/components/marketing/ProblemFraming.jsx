    ...
    <section className="py-20 bg-slate-950 border-t border-slate-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          {/* Identiqal */}
          <div className="bg-indigo-950/20 border border-indigo-900/40 rounded-2xl p-6 relative overflow-hidden shadow-lg shadow-indigo-950/10">
            <div className="absolute top-4 right-4 text-indigo-500/20">
              <CheckCircle2 size={64} />
            </div>
            <h3 className="text-lg font-bold text-slate-100 mb-4 flex items-center space-x-2">
              <CheckCircle2 className="text-indigo-400 shrink-0" size={20} />
              <span className="bg-gradient-to-r from-blue-400 to-indigo-400 bg-clip-text text-transparent">Identiqal Cards</span>
            </h3>
