    ...
    >
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
        ...
        <AnimatedSection delay={0.1}>
          <div className="overflow-x-auto rounded-2xl border border-primary/6 shadow-lg bg-white/50 backdrop-blur-md">
            <table className="w-full border-collapse text-left text-sm font-sans">
              <thead>
                <tr className="border-b border-primary/6 bg-primary/4 text-primary font-bold text-xs uppercase tracking-wider">
                  <th className="p-6">Feature / Ability</th>
                  <th className="p-6">Traditional Card</th>
                  <th className="p-6 bg-primary/4">Identiqal Profile</th>
                </tr>
              </thead>
              <motion.tbody
                ...
                {comparisonRows.map((row, index) => (
                  <motion.tr
                    ...
                    whileHover={
                      shouldReduceMotion
                        ? {}
                        : { backgroundColor: "rgba(74, 44, 58, 0.025)" }
                    }
                    className="transition-colors duration-200"
                  >
                    <td className="p-6 font-bold text-brand-text">
                      {row.feature}
                    </td>
                    <td className="p-6 text-brand-secondary font-medium">
                    ...
                    <td className="p-6 text-brand-text font-semibold bg-primary/3">
                      <div className="flex items-center space-x-2">
                        <motion.span
                          whileHover={
