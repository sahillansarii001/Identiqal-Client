...
import { ArrowRight, ShieldAlert, Check, ChevronLeft, EyeOff, Eye } from 'lucide-react';
        ...
        <div className="mx-auto w-full max-w-sm lg:w-[400px]">
          ...
          <div className="text-left mb-8">
            <div className="flex items-center space-x-2 mb-6">
               {step === 2 && (
                 <button onClick={() => setStep(1)} className="p-2 -ml-2 rounded-full hover:bg-gray-100 transition-colors">
                   <ChevronLeft size={20} className="text-[#1F1F1F]" />
                 </button>
               )}
               <Link href="/" className="inline-flex items-center space-x-2 text-2xl font-black tracking-tight text-[#1F1F1F]">
          ...
          <form onSubmit={step === 3 ? onVerifyOtp : step === 2 ? handleSubmit(onSubmit) : (e) => { e.preventDefault(); handleNextStep(); }} className="space-y-4 text-left">
            ...
            {step === 1 && (
              <div className="animate-in fade-in slide-in-from-right-4 duration-300 space-y-4">
                ...
                <Button type="submit" className="w-full py-4 mt-2 text-base font-bold rounded-full">
                  <span>Continue</span>
                </Button>
            ...
            {step === 2 && (
              <div className="animate-in fade-in slide-in-from-right-4 duration-300 space-y-4">
                ...
                <div className="space-y-1">
                  <label className="block text-xs font-bold text-[#1F1F1F]">Username</label>
                  <div className="relative">
                    <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                      <span className="text-gray-500 sm:text-sm">identiqal.com/</span>
                    </div>
                    <input
                      type="text"
