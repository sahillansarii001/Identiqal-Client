    ...
    <div className="flex min-h-screen bg-[#FAF8F6] items-center justify-center p-4">
      ...
      <div className="relative z-10 w-full max-w-md bg-white border border-[#E9E2DC] rounded-3xl p-8 shadow-xl shadow-[#5A3342]/5 relative">
        ...
        <div className="text-center mb-8">
          ...
          <h2 className="text-xl font-bold text-[#1F1F1F] font-sans">Welcome Back</h2>
          <p className="text-xs text-[#6B6B6B] mt-1 font-medium">Sign in to manage your digital cards</p>
        </div>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 text-left">
          ...
          <div className="flex items-center justify-between text-xs font-semibold pt-1">
            <button
              ...
              className="flex items-center space-x-2 text-[#6B6B6B] hover:text-[#1F1F1F]"
            >
