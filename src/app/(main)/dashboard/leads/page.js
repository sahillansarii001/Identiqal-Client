        ...
        {cards.length > 0 && (
          ...
          >
            ...
            {user?.subscriptionTier === "free" && (
              <span className="text-[8px] bg-[#3B82F6] text-white px-1.5 py-0.5 rounded-md uppercase font-black ml-1">
                Pro
              </span>
            )}
          </button>
      ...
      {loadingCards ? (
        ...
        <div className="text-center py-24 bg-white border border-[#E2E8F0] rounded-3xl space-y-5 shadow-sm shadow-[#2563EB]/3">
          <div className="w-16 h-16 bg-[#2563EB]/5 rounded-2xl flex items-center justify-center mx-auto">
            <Inbox size={28} className="text-[#2563EB]" />
          </div>
          ...
          {loadingLeads ? (
            ...
            <div className="space-y-4">
              {leads.map((lead) => (
                <div
                  key={lead._id}
                  className="p-5 bg-white border border-[#E2E8F0] hover:border-[#2563EB]/20 rounded-2xl space-y-4 transition-all duration-200 shadow-sm shadow-[#2563EB]/3 hover:shadow-md hover:shadow-[#2563EB]/5"
                >
