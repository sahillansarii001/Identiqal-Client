...
export default function DashboardOverviewPage() {
  ...
  return (
    <div className="space-y-8 w-full pb-12">
      ...
      <div className="bg-linear-to-br from-[#5A3045] via-[#4A2033] to-[#2E101E] border border-[rgba(90,48,69,0.15)] rounded-[24px] p-6 md:p-8 relative overflow-hidden flex flex-col md:flex-row items-start md:items-center justify-between gap-6 shadow-lg shadow-[#5A3045]/5 group">
        ...
        <div className="relative shrink-0 hidden md:block z-10 w-44 h-28 select-none">
          ...
          >
            <div className="flex items-center justify-between">
              <div className="w-8 h-8 rounded-full bg-linear-to-tr from-[#D4A45B] to-[#5A3045] flex items-center justify-center font-bold text-white text-[9px]">
          ...
          <div className="absolute -inset-1 rounded-3xl bg-linear-to-r from-[#D4A45B]/10 to-[#5A3045]/10 blur-md -z-10 opacity-70" />
        </div>
      </div>
      ...
      <div className="grid sm:grid-cols-3 gap-6 text-left">
        ...
        <div className="bg-white border border-[rgba(90,48,69,0.08)] rounded-[24px] p-6 space-y-4 shadow-xs relative overflow-hidden group hover:-translate-y-1 hover:shadow-md transition-all duration-300">
          ...
          <div className="absolute bottom-0 inset-x-0 h-1 bg-linear-to-r from-[#5A3045]/50 to-[#D4A45B]/50 opacity-0 group-hover:opacity-100 transition-opacity" />
        </div>
        ...
        <div className="bg-white border border-[rgba(90,48,69,0.08)] rounded-[24px] p-6 space-y-4 shadow-xs relative overflow-hidden group hover:-translate-y-1 hover:shadow-md transition-all duration-300">
          ...
          <div className="absolute bottom-0 inset-x-0 h-1 bg-linear-to-r from-[#D4A45B]/50 to-[#5A3045]/50 opacity-0 group-hover:opacity-100 transition-opacity" />
        </div>
        ...
        <div className="lg:col-span-8 bg-white border border-[rgba(90,48,69,0.08)] rounded-[24px] p-6 space-y-6 shadow-xs relative">
          <div className="flex items-center justify-between">
            ...
            <Link
              ...
              className="text-xs text-[#5A3045] hover:text-[#D4A45B] font-bold flex items-center space-x-1 transition-colors"
            >
              <span>View All</span>
              ...
              {cards.slice(0, 4).map((card) => (
                ...
                >
                  <div className="space-y-2">
                    <div className="flex items-center justify-between">
                      {/* Mini Thumbnail */}
                      <div className="w-7 h-7 rounded-lg bg-linear-to-tr from-[#5A3045] to-[#D4A45B] flex items-center justify-center font-bold text-white text-[8px] shadow-sm">
                    ...
                    <div className="text-left space-y-0.5 pt-1">
                      <h4 className="text-xs font-extrabold text-inherit truncate group-hover:text-[#5A3045] transition-colors">
                        {card.title}
                      </h4>
