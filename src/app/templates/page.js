...
const initialTemplates = [
  {
    ...
    description: 'Inspired by modern software design systems. Features subtle gold-borders, dark-mode blocks, and active calendar integrations.',
  },
  {
    ...
    rating: 4.8,
    author: 'Identiqal Studio',
    description: 'A clean, typography-focused layout featuring a single avatar, simple bios, and a pristine vertical block arrangement.',
  },
  {
    id: 'gold-luxury',
    name: 'Gold Luxury',
    ...
    rating: 4.9,
    author: 'Identiqal Studio',
    description: 'Ivory layouts accented with warm gold details, italics, and custom glassmorphism borders for premium professionals.',
  },
  {
    id: 'startup-bold',
    name: 'Startup Bold',
    ...
    rating: 4.7,
    author: 'Identiqal Studio',
    description: 'Dynamic gradient-filled blocks, floating contact forms, and custom inquiry blocks built for launching team pages.',
  },
  {
    id: 'agency-creative',
    ...
    rating: 4.9,
    author: 'Identiqal Studio',
    description: 'Strong grid visuals, custom social layouts, embedded client testimonial carousels, and portfolio photo links.',
  },
  {
    ...
    rating: 4.8,
    author: 'Identiqal Studio',
    description: 'Optimized photo grid galleries, minimal profiles, dark mode triggers, and high-resolution picture background states.',
  },
  {
    id: 'healthcare-pro',
    name: 'Healthcare Pro',
    ...
    rating: 4.6,
    author: 'Identiqal Studio',
    description: 'Tailored for doctors and practitioners. Features direct appointment booking link integrations and clinic maps.',
  },
  {
    id: 'realestate-clean',
    ...
    rating: 4.7,
    author: 'Identiqal Studio',
    description: 'Clean layouts with prominent phone CTA buttons, photo showcases, lead forms, and agency logo locking blocks.',
  },
];
...
export default function TemplatesPage() {
  ...
  const [aiAnswers, setAiAnswers] = useState({ profession: '', goal: '', style: '' });
  ...
  const handleAiQuizSubmit = () => {
    ...
    if (aiAnswers.profession === 'Developer') {
      matchId = 'linear-dark';
    } else if (aiAnswers.style === 'Luxury & Gold' || aiAnswers.profession === 'Freelancer') {
      matchId = 'gold-luxury';
    } else if (aiAnswers.goal === 'Capture Leads' || aiAnswers.profession === 'Startup') {
      matchId = 'startup-bold';
    } else if (aiAnswers.profession === 'Designer' || aiAnswers.style === 'Creative & Glass') {
  ...
  const filteredTemplates = useMemo(() => {
    return initialTemplates.filter(t => {
      ...
      const matchesColors =
        ...
        selectedColors.some(colorHex => t.colors.some(c => c.toLowerCase() === colorHex.toLowerCase()));

      return matchesSearch && matchesCategory && matchesStyles && matchesColors;
    }).sort((a, b) => {
  ...
  const featuredTemplates = useMemo(() => {
    return initialTemplates.filter(t => t.badge === 'PREMIUM' || t.badge === 'AI PICK');
  }, []);
  ...
  return (
    <div className="flex flex-col min-h-screen bg-[#FAF8F6] text-[#1F1F1F]">
      ...
      <main className="flex-1 pt-24 pb-20">
        ...
        <section className="relative py-20 px-6 overflow-hidden">
          ...
          <div className="relative z-10 max-w-7xl mx-auto grid lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-7 space-y-6 text-left">
              ...
              <p className="text-base sm:text-lg text-[#6B6B6B] max-w-xl font-medium">
                Professionally designed templates for developers, creators, freelancers, businesses, agencies, students and networking professionals.
              </p>
            ...
            <div className="lg:col-span-5 relative h-[380px] hidden lg:flex justify-center items-center">
              {/* Stacked template 1 */}
              <div className="absolute top-4 left-6 w-[200px] bg-white border border-[#E9E2DC] p-4 rounded-2xl shadow-lg shadow-[#5A3342]/5 rotate-[-6deg] animate-float z-10 select-none">
                <div className="w-10 h-10 rounded-full bg-[#5A3342]/10 flex items-center justify-center text-[#5A3342] font-bold mb-3">AM</div>
              ...
              <div className="absolute bottom-4 right-6 w-[210px] bg-[#1F1F1F] border border-zinc-800 p-4 rounded-2xl shadow-2xl rotate-[8deg] animate-float-slow z-20 select-none">
                <div className="w-9 h-9 rounded-full bg-gradient-to-tr from-[#5A3342] to-[#C89B5B] mb-3" />
              ...
              {/* Stacked template 3 */}
              <div className="absolute top-1/3 right-12 w-[190px] bg-[#FAF8F6] border border-[#C89B5B]/20 p-4 rounded-2xl shadow-xl shadow-[#5A3342]/3 rotate-[1deg] animate-float-fast z-15 select-none">
                <div className="w-8 h-8 rounded-full bg-[#C89B5B]/20 border border-[#C89B5B]/30 flex items-center justify-center text-[#C89B5B] font-bold text-xs mb-3">JD</div>
        ...
        <section className="py-8 bg-white border-y border-[#E9E2DC] overflow-hidden select-none">
          ...
          <div className="relative w-full overflow-hidden flex items-center">
            ...
            <div className="flex space-x-8 animate-marquee-templates min-w-full py-2">
              {[...featuredTemplates, ...featuredTemplates, ...featuredTemplates].map((item, idx) => (
                <div
                  key={idx}
                ...
                >
                  <div className="space-y-3">
                    <div className="flex justify-between items-start">
                      ...
                      <span className="text-[10px] font-bold text-[#C89B5B]">★ {item.rating}</span>
                    </div>
                    <div>
                      <h4 className="font-extrabold text-sm text-[#1F1F1F]">{item.name}</h4>
                      <p className="text-[10px] text-[#6B6B6B]">{item.category} • {item.styles.join(', ')}</p>
                    </div>
                  </div>
            ...
            <div className="bg-[#5A3342]/5 border border-[#5A3342]/10 rounded-2xl p-6 sm:p-8 flex flex-col sm:flex-row items-center justify-between gap-6">
              <div className="space-y-2 text-left">
                ...
                <p className="text-xs text-[#6B6B6B] max-w-xl">
                  Take a quick 3-question AI design match quiz. We will recommend the perfect smart landing templates based on your objectives and field.
                </p>
              </div>
              <button
            ...
            <div className="bg-white border border-[#E9E2DC] rounded-2xl p-6 sm:p-8 space-y-6 text-left shadow-sm shadow-[#5A3342]/3">
              <div className="flex items-center justify-between border-b border-[#E9E2DC] pb-4">
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-sm font-bold text-[#1F1F1F]">AI Recommended Assistant</span>
                </div>
                <button onClick={() => setAiQuizStep(0)} className="text-[#6B6B6B] hover:text-[#1F1F1F]">
                  <X size={16} />
                </button>
              </div>
              ...
              {aiQuizStep === 1 && (
                <div className="space-y-4">
                  <p className="text-xs font-bold text-[#6B6B6B]">STEP 1 of 3: What is your primary profession?</p>
                  <div className="flex flex-wrap gap-2">
                    {['Developer', 'Designer', 'Freelancer', 'Startup Leader', 'Creator'].map((prof) => (
                      <button
                        key={prof}
                        onClick={() => {
              ...
              {aiQuizStep === 2 && (
                <div className="space-y-4">
                  <p className="text-xs font-bold text-[#6B6B6B]">STEP 2 of 3: What is your primary networking goal?</p>
                  <div className="flex flex-wrap gap-2">
                    {['Build Portfolio', 'Capture Leads', 'Share Social Links', 'Book Appointments'].map((goal) => (
                      <button
                        key={goal}
                        onClick={() => {
                  ...
                  <button onClick={() => setAiQuizStep(1)} className="text-[10px] font-bold text-[#6B6B6B] underline pt-2 block">
                    ← Back to Step 1
                  </button>
                </div>
              )}
              ...
              {aiQuizStep === 3 && (
                <div className="space-y-4">
                  <p className="text-xs font-bold text-[#6B6B6B]">STEP 3 of 3: Which style aesthetic feels best?</p>
                  <div className="flex flex-wrap gap-2">
                    {['Clean & Minimal', 'Dark & Tech', 'Luxury & Gold', 'Creative & Glass'].map((style) => (
                      <button
                        key={style}
                        onClick={() => {
                          ...
                          setTimeout(() => {
                            let matchId = 'studio-minimalist';
                            if (updated.profession === 'Developer') matchId = 'linear-dark';
                            else if (updated.style === 'Luxury & Gold' || updated.profession === 'Freelancer') matchId = 'gold-luxury';
                            else if (updated.goal === 'Capture Leads' || updated.profession === 'Startup Leader') matchId = 'startup-bold';
                            else if (updated.profession === 'Designer' || updated.style === 'Creative & Glass') matchId = 'agency-creative';

                            const match = initialTemplates.find(t => t.id === matchId);
                  ...
                  <button onClick={() => setAiQuizStep(2)} className="text-[10px] font-bold text-[#6B6B6B] underline pt-2 block">
                    ← Back to Step 2
                  </button>
                </div>
              )}
              ...
              {aiQuizStep === 4 && aiRecommendation && (
                <div className="space-y-4 bg-[#5A3342]/5 border border-[#5A3342]/10 p-5 rounded-2xl flex flex-col sm:flex-row items-center justify-between gap-6">
                  <div className="space-y-1.5 text-left">
                    ...
                    <h4 className="font-extrabold text-base text-[#1F1F1F]">{aiRecommendation.name}</h4>
                    <p className="text-xs text-[#6B6B6B] max-w-lg">{aiRecommendation.description}</p>
                  </div>
        ...
        <section id="marketplace" className="max-w-7xl mx-auto px-6 grid lg:grid-cols-12 gap-8 pt-6">
            ...
            <div className="sticky top-24 bg-white border border-[#E9E2DC] rounded-2xl p-6 space-y-6 shadow-sm shadow-[#5A3342]/3 text-left">
              <div className="flex items-center justify-between border-b border-[#E9E2DC] pb-3">
                ...
                <button
                  ...
                  className="text-[10px] font-bold text-[#6B6B6B] hover:text-[#5A3342] underline transition-colors"
                >
                  Reset All
                </button>
              </div>
              ...
              <div className="space-y-2">
                <h4 className="text-[11px] font-black text-[#1F1F1F] uppercase tracking-wider">Category</h4>
                    ...
                    <button
                      ...
                      className={`w-full text-left px-2.5 py-1.5 rounded-lg text-xs font-semibold transition-all ${
                        selectedCategory === cat
                          ...
                          : 'text-[#6B6B6B] hover:bg-[#FAF8F6] hover:text-[#1F1F1F]'
                      }`}
                    >
                      {cat}
                    </button>
              ...
              <div className="space-y-2 border-t border-[#E9E2DC] pt-4">
                <h4 className="text-[11px] font-black text-[#1F1F1F] uppercase tracking-wider">Style</h4>
                  ...
                  {stylesList.map((style) => {
                    ...
                    return (
                      <button
                        ...
                        className="flex items-center space-x-2 w-full text-left py-1 text-xs font-medium text-[#6B6B6B] hover:text-[#1F1F1F]"
                      >
                        <div className={`w-3.5 h-3.5 rounded border flex items-center justify-center transition-all ${
                          isChecked ? 'bg-[#5A3342] border-[#5A3342]' : 'border-[#E9E2DC]'
                        }`}>
                          {isChecked && <Check size={8} className="text-white" strokeWidth={4} />}
                        </div>
                        <span>{style}</span>
                      </button>
                    );
              ...
              {/* Color selector */}
              <div className="space-y-2 border-t border-[#E9E2DC] pt-4">
                <h4 className="text-[11px] font-black text-[#1F1F1F] uppercase tracking-wider">Color</h4>
                    ...
                    return (
                      <button
                        ...
                        className={`w-6 h-6 rounded-full border border-black/5 flex items-center justify-center shadow-sm relative hover:scale-110 transition-transform ${
                          isSelected ? 'ring-2 ring-[#5A3342] ring-offset-2' : ''
                        }`}
                        title={col.name}
                      >
                        {isSelected && <Check size={10} className={col.name === 'white' ? 'text-black' : 'text-white'} />}
                      </button>
                    );
                  })}
                </div>
              ...
              {/* Sorting */}
              <div className="space-y-2 border-t border-[#E9E2DC] pt-4">
                <h4 className="text-[11px] font-black text-[#1F1F1F] uppercase tracking-wider">Sort By</h4>
                <select
                  value={sortBy}
          ...
          <div className="lg:col-span-9 space-y-6">
            {filteredTemplates.length === 0 ? (
              <div className="bg-white border border-[#E9E2DC] rounded-2xl p-16 text-center space-y-4">
                <p className="text-sm font-semibold text-[#6B6B6B]">No templates matched your current filter selections.</p>
                <button
                  onClick={resetFilters}
                ...
                {filteredTemplates.map((template) => {
                  ...
                  return (
                    ...
                    >
                      {/* Badge / Ribbon */}
                      {template.badge && (
                        <span className={`absolute top-3.5 left-3.5 z-10 px-2 py-0.5 text-white text-[8px] font-black uppercase tracking-wider rounded ${
                          template.badge === 'AI PICK' ? 'bg-[#C89B5B]' : 'bg-[#5A3342]'
                        }`}>
                          {template.badge}
                        </span>
                      )}
                      ...
                      <div className="h-44 bg-[#FAF8F6] border-b border-[#E9E2DC] relative flex items-center justify-center p-4 overflow-hidden group-hover:bg-[#FAF8F6]/50 transition-colors">
                        ...
                        <div className="w-[110px] bg-white border border-[#E9E2DC] p-3 rounded-xl shadow-md rotate-[-4deg] group-hover:scale-105 group-hover:rotate-0 transition-all duration-300">
                          <div className="w-6 h-6 rounded-full bg-gradient-to-tr from-[#5A3342] to-[#C89B5B] mb-2" />
                        ...
                        >
                          <Heart size={11} fill={isFavorited ? '#5A3342' : 'none'} className={isFavorited ? 'text-[#5A3342]' : 'text-[#6B6B6B]'} />
                        </button>
                      </div>
                      ...
                      <div className="p-5 space-y-2">
                        <div className="flex justify-between items-center">
                          ...
                          <span className="text-[10px] font-bold text-[#C89B5B]">★ {template.rating}</span>
                        </div>
                        <h4 className="font-extrabold text-sm text-[#1F1F1F]">{template.name}</h4>
                        <div className="flex flex-wrap gap-1">
                          {template.styles.map((style) => (
                            <span key={style} className="text-[8px] font-semibold bg-[#FAF8F6] text-[#6B6B6B] border border-[#E9E2DC] px-1.5 py-0.5 rounded">
                              {style}
                            </span>
                          ))}
                        </div>
        ...
        <section className="max-w-7xl mx-auto px-6 pt-24 text-center">
          <div className="bg-[#5A3342] border border-[#E9E2DC] rounded-3xl p-12 sm:p-16 relative overflow-hidden shadow-xl shadow-[#5A3342]/10 text-center">
            ...
            <div className="relative z-10 space-y-6">
              <h3 className="text-2xl sm:text-3xl font-black text-white">Make a premium first impression today.</h3>
              <p className="text-xs sm:text-sm text-zinc-300 max-w-lg mx-auto">
                No credit card required. Connect your accounts, lock custom templates, and share via NFC or redirectable link slugs.
              </p>
          ...
          <div className="w-full max-w-5xl bg-[#FAF8F6] border border-[#E9E2DC] rounded-2xl shadow-2xl flex flex-col h-[90vh] overflow-hidden">
            ...
            <div className="bg-white border-b border-[#E9E2DC] px-6 py-4 flex items-center justify-between shrink-0">
              <div className="flex items-center space-x-3 text-left">
                <h3 className="font-extrabold text-base text-[#1F1F1F]">{selectedTemplate.name}</h3>
              ...
              <div className="hidden sm:flex items-center space-x-6">
                ...
                <div className="flex border border-[#E9E2DC] rounded-lg p-0.5 bg-[#FAF8F6]">
                  <button
                    ...
                    className={`p-1.5 rounded-md ${previewViewport === 'desktop' ? 'bg-white shadow-sm text-[#5A3342]' : 'text-[#6B6B6B] hover:text-[#1F1F1F]'}`}
                  ...
                  <button
                    ...
                    className={`p-1.5 rounded-md ${previewViewport === 'tablet' ? 'bg-white shadow-sm text-[#5A3342]' : 'text-[#6B6B6B] hover:text-[#1F1F1F]'}`}
                  ...
                  <button
                    ...
                    className={`p-1.5 rounded-md ${previewViewport === 'mobile' ? 'bg-white shadow-sm text-[#5A3342]' : 'text-[#6B6B6B] hover:text-[#1F1F1F]'}`}
                ...
                <div className="flex border border-[#E9E2DC] rounded-lg p-0.5 bg-[#FAF8F6]">
                  <button
                    ...
                    className={`p-1.5 rounded-md ${previewTheme === 'light' ? 'bg-white shadow-sm text-[#5A3342]' : 'text-[#6B6B6B] hover:text-[#1F1F1F]'}`}
                  ...
                  <button
                    ...
                    className={`p-1.5 rounded-md ${previewTheme === 'dark' ? 'bg-white shadow-sm text-[#5A3342]' : 'text-[#6B6B6B] hover:text-[#1F1F1F]'}`}
              ...
              <div className="flex items-center space-x-3">
                ...
                <button
                  ...
                  className="p-1.5 rounded-lg border border-[#E9E2DC] text-[#6B6B6B] hover:text-[#1F1F1F] hover:bg-slate-100 transition-colors"
                >
                  <X size={16} />
                </button>
              </div>
