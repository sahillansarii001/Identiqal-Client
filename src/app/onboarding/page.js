  ...
  const handleNext = async (stepName, payload) => {
    ...
    try {
      if (stepName === "subscription" && payload.plan === "pro") {
        await axiosInstance.post("/onboarding/update", {
          step: stepName,
          data: payload,
        });
        setStep(1.5);
      ...
      console.error(
        "Failed to update onboarding step. Message:",
        error.message,
      );
      console.error("Response data:", error.response?.data);
      console.error("Config URL:", error.config?.url);
      alert(
        "Network Error: Could not reach the server. Please check your connection or backend server.",
      );
    } finally {
      setIsLoading(false);
    }
      ...
      <div className="relative z-10 w-full max-w-2xl bg-white rounded-3xl p-8 sm:p-12 shadow-xl shadow-[#2563EB]/5 border border-[#E2E8F0]">
          ...
          <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              ...
              >
                ...
                <ul className="text-sm text-gray-600 space-y-2">
                  <li className="flex items-center">
                    <Check size={16} className="mr-2 text-green-500" /> Basic
                    digital card
                  </li>
                  <li className="flex items-center">
                    <Check size={16} className="mr-2 text-green-500" /> Standard
                    themes
                  </li>
                  <li className="flex items-center">
                    <Check size={16} className="mr-2 text-green-500" /> 5
                    platform links
                  </li>
                </ul>
              </button>
              ...
              >
                ...
                <ul className="text-sm text-gray-600 space-y-2">
                  <li className="flex items-center">
                    <Check size={16} className="mr-2 text-green-500" /> Advanced
                    analytics
                  </li>
                  <li className="flex items-center">
                    <Check size={16} className="mr-2 text-green-500" /> Premium
                    themes
                  </li>
                  <li className="flex items-center">
            ...
            <div className="mt-8 flex justify-end">
              <Button
                ...
                onClick={() =>
                  handleNext("subscription", { plan: selectedPlan })
                }
        ...
        {step === 2 && (
          <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <p className="text-gray-500 text-center mb-8">
              How are you planning to use Identiqal?
            </p>
            <div className="space-y-4">
                ...
                (themeName, idx) => (
                  ...
                  >
                    <div className="absolute inset-0 bg-gray-100 flex flex-col items-center justify-center p-4">
                      <div
                        className={`w-16 h-16 rounded-full mb-4 ${idx === 1 ? "bg-gray-800" : "bg-white shadow"}`}
                      ></div>
                      <div
                        className={`w-3/4 h-4 rounded-full mb-2 ${idx === 1 ? "bg-gray-700" : "bg-gray-200"}`}
                      ></div>
                      <div
                        className={`w-1/2 h-4 rounded-full ${idx === 1 ? "bg-gray-700" : "bg-gray-200"}`}
                      ></div>
                    </div>
                    {/* Theme label */}
        ...
        {step === 4 && (
          <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <p className="text-gray-500 text-center mb-8">
              Select the platforms you want to link.
            </p>
            <div className="grid grid-cols-2 gap-4">
              {[
            ...
            <div className="mt-8 flex justify-end">
              <Button
                ...
                onClick={() =>
                  handleNext("platforms", { platforms: selectedPlatforms })
                }
                className="w-full sm:w-auto px-8"
                isLoading={isLoading}
              >
        ...
        {step === 5 && (
          <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <p className="text-gray-500 text-center mb-8">
              Enter the URLs for the platforms you selected.
            </p>
            <div className="space-y-4">
            ...
            <div className="mt-8 flex justify-end">
              <Button
                onClick={() => {
                  const linksData = selectedPlatforms.map((p) => ({
                    platform: p,
                    url: links[p] || "",
                  }));
        ...
        {step === 7 && (
          <div className="animate-in zoom-in-95 duration-500 text-center py-8">
            ...
            <p className="text-gray-500 mb-8 max-w-sm mx-auto">
              Your Identiqal page is ready. You can now access your dashboard to
              view analytics, add more content, and customize your page further.
            </p>
            <Button
