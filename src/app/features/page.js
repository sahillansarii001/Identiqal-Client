      ...
      <main className="flex-1 pt-24 pb-20">
        ...
        <section className="relative py-24 px-6 overflow-hidden">
          <div className="absolute inset-0 z-0 pointer-events-none">
            <div className="absolute -top-40 left-1/4 w-[550px] h-[550px] rounded-full bg-[#5A3342]/5 blur-[120px]" />
          ...
          <div className="relative z-10 max-w-7xl mx-auto text-center space-y-8">
            ...
            <div className="flex items-center justify-center gap-4 pt-2">
              <Link href="/signup">
                <button className="bg-[#5A3342] text-white hover:bg-[#6A3B4B] font-semibold px-8 py-4 rounded-xl transition-all shadow-md">
                  Get Started Free
                </button>
              </Link>
              <a href="#suite">
                <button className="bg-white border border-[#E9E2DC] hover:border-[#5A3342]/30 text-[#5A3342] font-semibold px-8 py-4 rounded-xl transition-all">
                  Explore Features
                </button>
              </a>
            </div>
          ...
          <div className="lg:col-span-5 space-y-6 text-left">
            ...
            <div className="space-y-2 pt-2">
              <div className="flex items-center space-x-2 text-xs font-semibold text-[#1F1F1F]">
                <Check size={14} className="text-[#C89B5B]" />
