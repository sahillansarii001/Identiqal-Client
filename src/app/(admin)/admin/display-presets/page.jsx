          ...
          <div className="space-y-4 pt-2">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <select value={form.headerStyle} onChange={e => handleChange('headerStyle', e.target.value)} className="w-full px-3 py-2 bg-white dark:bg-black/20 border border-gray-200 dark:border-white/10 rounded-lg text-xs focus:outline-none focus:ring-2 focus:ring-[#2563EB]">
              ...
              <div>
                ...
                <input type="text" value={form.headerHeight} onChange={e => handleChange('headerHeight', e.target.value)} className="w-full px-3 py-2 bg-white dark:bg-black/20 border border-gray-200 dark:border-white/10 rounded-lg text-xs focus:outline-none focus:ring-2 focus:ring-[#2563EB]" placeholder="e.g., 200px" />
              </div>
              <div className="col-span-2">
                <label className="block text-xs font-medium text-gray-700 dark:text-gray-300 mb-1">Background Type</label>
                <select value={form.backgroundType} onChange={e => handleChange('backgroundType', e.target.value)} className="w-full px-3 py-2 bg-white dark:bg-black/20 border border-gray-200 dark:border-white/10 rounded-lg text-xs focus:outline-none focus:ring-2 focus:ring-[#2563EB]">
          ...
          <div className="space-y-4 pt-2">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <select value={form.profilePhotoStyle} onChange={e => handleChange('profilePhotoStyle', e.target.value)} className="w-full px-3 py-2 bg-white dark:bg-black/20 border border-gray-200 dark:border-white/10 rounded-lg text-xs focus:outline-none focus:ring-2 focus:ring-[#2563EB]">
              ...
              <div>
                ...
                <select value={form.profilePhotoPosition} onChange={e => handleChange('profilePhotoPosition', e.target.value)} className="w-full px-3 py-2 bg-white dark:bg-black/20 border border-gray-200 dark:border-white/10 rounded-lg text-xs focus:outline-none focus:ring-2 focus:ring-[#2563EB]">
          ...
          <div className="space-y-4 pt-2">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <select value={form.cardShape} onChange={e => handleChange('cardShape', e.target.value)} className="w-full px-3 py-2 bg-white dark:bg-black/20 border border-gray-200 dark:border-white/10 rounded-lg text-xs focus:outline-none focus:ring-2 focus:ring-[#2563EB]">
              ...
              <div>
                ...
                <select value={form.animationStyle} onChange={e => handleChange('animationStyle', e.target.value)} className="w-full px-3 py-2 bg-white dark:bg-black/20 border border-gray-200 dark:border-white/10 rounded-lg text-xs focus:outline-none focus:ring-2 focus:ring-[#2563EB]">
