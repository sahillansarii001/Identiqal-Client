          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between p-4 rounded-lg border border-gray-100 dark:border-white/10 bg-gray-50/50 dark:bg-white/5">
              ...
              <button
                ...
                className={`relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 focus:outline-none ${settings.allowSignups ? 'bg-[#5A3045]' : 'bg-gray-200 dark:bg-white/20'}`}
              >
        ...
        <div className="bg-white dark:bg-[#111] border border-red-100 dark:border-red-500/20 rounded-xl p-6 shadow-sm">
          ...
          <div className="flex items-center justify-between p-4 rounded-lg border border-red-100 dark:border-red-500/20 bg-red-50/50 dark:bg-red-500/5">
            ...
            <button
              ...
              className={`relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 focus:outline-none ${settings.maintenanceMode ? 'bg-red-500' : 'bg-gray-200 dark:bg-white/20'}`}
            >
